        ...
        <div class="sidebar">
          ...
          <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
              ...
              <li class="nav-item">
                <a href="../../views/admin/product_view.php" class="nav-link nav-link-product">Quản trị sản phẩm</a>
              </li>

            </ul>
            <div class="">
              <a class="btn btn-block btn-outline-primary" href="../../models/admin/logout_admin.php" role="button">Đăng xuất</a>
            </div>
          </nav>
          <!-- /.sidebar-menu -->
        </div>
