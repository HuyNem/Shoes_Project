...
?>
    ...
    <body>
        ...
        <form method="POST" enctype="multipart/form-data" action="profile_cus_action.php">
            <div class="container rounded bg-white mt-5">
                <div class="row">
                    <div class="col-md-4 border-right">
                        <div class="d-flex flex-column align-items-center text-center p-3 py-5" style="border-right: 1px solid; margin-right: 10px;">
                            <img class="rounded-circle mt-5" src='./image/customer/<?php echo $r["AnhCus"]; ?>' width="150">
